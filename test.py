# By importing re we are telling Python "Hey, I need you to know about regular expressions."
import re
...
def parse_input(user_input):
    ...
    for coord in str_coords:
        ...
        # Convert the letter to a coordinate
        if (x == "a"):
            x = 1
        elif (x == "b"):
            x = 2
...
class Coordinate:
    ...
    def __init__(self, X, Y):
      """When we create a new coordinate this is the method that makes it"""
      self.x = X
      self.y = Y

    def __repr__(self):
      """This function defines what happens when we print(a_coordinate)."""
